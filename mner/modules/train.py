...
class NERTrainer(BaseTrainer):
            ...
            with tqdm(total=len(self.dev_data), leave=False, dynamic_ncols=True) as pbar:
                ...
                for batch in self.dev_data:
                    ...
                    attention_mask, labels, logits, loss = self._step(batch,
                                                                      mode="dev")  # logits: batch, seq, num_labels
    ...
    def _step(self, batch, mode="train"):
        ...
        # images_dif, aux_imgs_dif = None, None
        # weight = None
        # input_ids_g, attention_mask_g = None, None
        # input_ids, attention_mask, labels = batch
        input_ids, attention_mask, labels, images, missing_indexs = batch
        output = self.model(input_ids=input_ids, attention_mask=attention_mask,
                            labels=labels, images=images, missing_indexs=missing_indexs)
